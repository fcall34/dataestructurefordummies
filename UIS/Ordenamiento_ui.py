...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QRect(80, 40, 631, 41))
        font = QFont()
...
"")
        ...
        self.label_3.setGeometry(QRect(80, 10, 631, 91))
        self.label_3.setFont(font)
        self.label_3.setStyleSheet(u"background-color:transparent;color:black")
        self.label_3.setAlignment(Qt.AlignmentFlag.AlignCenter)
        MainWindow.setCentralWidget(self.centralwidget)
        self.QUICKSORT.raise_()
        self.MERGESORT.raise_()
        self.HEAPSORT.raise_()
        self.COUNTINGSORT.raise_()
        self.ATRAS.raise_()
        self.label_2.raise_()
        self.label_3.raise_()
        self.label.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"METODOS DE ORDENAMIENTO", None))
    # retranslateUi
