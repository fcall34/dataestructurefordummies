...
class Ui_MenuTemas(object):
    def setupUi(self, MenuTemas):
        ...
        MenuTemas.setStyleSheet(u"background-color: rgb(51,102,255\n"
")")
        ...
        self.btnListas.setStyleSheet(u"background-color: rgb(150,85,255)")
        ...
        self.btnArboles.setStyleSheet(u"background-color: rgb(150,85,255)")
        self.btnHash = QPushButton(self.centralwidget)
        self.btnHash.setObjectName(u"btnHash")
        self.btnHash.setGeometry(QRect(180, 270, 141, 85))
        self.btnHash.setStyleSheet(u"background-color: rgb(150,85,255)")
        self.btnGrafos = QPushButton(self.centralwidget)
        self.btnGrafos.setObjectName(u"btnGrafos")
        self.btnGrafos.setGeometry(QRect(610, 150, 141, 81))
        self.btnGrafos.setStyleSheet(u"background-color: rgb(150,85,255)")
        self.btnOrdenamiento = QPushButton(self.centralwidget)
        self.btnOrdenamiento.setObjectName(u"btnOrdenamiento")
        self.btnOrdenamiento.setGeometry(QRect(470, 270, 141, 81))
        self.btnOrdenamiento.setStyleSheet(u"background-color: rgb(150,85,255)")
        self.btnStrassen = QPushButton(self.centralwidget)
        self.btnStrassen.setObjectName(u"btnStrassen")
        self.btnStrassen.setGeometry(QRect(320, 390, 141, 81))
        self.btnStrassen.setStyleSheet(u"background-color: rgb(150,85,255)")
